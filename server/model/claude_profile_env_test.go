...
func TestValidateClaudeProfileEnvsStrictTypedValues(t *testing.T) {
	tests := []struct {
		...
		{name: "positive integer invalid", key: "CLAUDE_CODE_MAX_CONTEXT_TOKENS", values: []string{"0", "-1", "+1", "1.0", " 1", ""}, wantErr: true},
		{name: "thinking integer valid", key: "MAX_THINKING_TOKENS", values: []string{"0", "1", "32000"}},
		{name: "thinking integer invalid", key: "MAX_THINKING_TOKENS", values: []string{"-1", "+1", "1.0", " 1", ""}, wantErr: true},
