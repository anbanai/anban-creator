...
var PlatformConfigs = map[string]*PlatformConfig{
	PlatformArticle: {
		...
		Fields: []PlatformFieldConfig{
			...
			{Key: "style", Label: "图片视觉", Placeholder: "例如 温暖治愈系水彩、极简几何线条、复古胶片质感", Type: "textarea", Group: "advanced"},
			{Key: "writing_style", Label: "创作风格", Placeholder: "例如 casual-science, dan-koe", Type: "select", Group: "advanced"},
