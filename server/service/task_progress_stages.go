...
//
// Stage names are extracted from plugins/anban/agents/{wechatarticle,seednote,moments}.md.
...
var stagePercentByType = map[string]map[string]int{
	...
	// Ecommerce stage slugs come from plugins/anban/agents/ecommerce.md
