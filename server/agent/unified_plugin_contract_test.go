...
func TestUnifiedPluginLayout(t *testing.T) {
	...
	if claudeManifest.Version != "4.1.4" {
		t.Fatalf("native manifest version = %q, want 4.1.4 for semantic image ratios and task-local Seednote templates", claudeManifest.Version)
	}
