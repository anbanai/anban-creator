...
func TestUnifiedPluginLayout(t *testing.T) {
	...
	if claudeManifest.Version != "4.1.5" {
		t.Fatalf("native manifest version = %q, want 4.1.5 for the authenticated Server MCP Seednote research contract", claudeManifest.Version)
	}
