...
var reviewedMCPHandlerCapabilities = map[string]string{
	...
	"downloadImageHandler":                    "svcs.TaskImageOperationsSvc.Download",
	...
	"progressPlanHandler":                     "svcs.TaskSvc.SetTaskProgressPlan",
	"progressUpdateHandler":                   "svcs.TaskSvc.UpdateTaskProgress",
