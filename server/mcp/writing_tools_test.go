...
// ---------------------------------------------------------------------------
// writeArticleHandler tests (argument validation only)
// ---------------------------------------------------------------------------

func TestWriteArticleHandler_MissingTopic(t *testing.T) {
	handler, cleanup := setupMCPHandlerWithServices(t)
	defer cleanup()
...
func TestResearchTopicsHandler_MissingProjectID(t *testing.T) {
	...
	text := callMCPTool(t, handler, "research_topics",
		`{}`,
		"test-api-key")
...
// ---------------------------------------------------------------------------
// optimizeSEOHandler tests (argument validation only)
// ---------------------------------------------------------------------------

func TestOptimizeSEOHandler_MissingContent(t *testing.T) {
	handler, cleanup := setupMCPHandlerWithServices(t)
	defer cleanup()
...
func TestOptimizeSEOHandler_MissingTitle(t *testing.T) {
	handler, cleanup := setupMCPHandlerWithServices(t)
	defer cleanup()
...
// ---------------------------------------------------------------------------
// generateOutlineHandler tests (argument validation only)
// ---------------------------------------------------------------------------

func TestGenerateOutlineHandler_MissingTopic(t *testing.T) {
	handler, cleanup := setupMCPHandlerWithServices(t)
	defer cleanup()
