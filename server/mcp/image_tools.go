...
func generateImageHandler(ctx context.Context, req *mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// (no task_id) and when no file was persisted (no file_path). A registration
	// error remains soft only when the generated file is already in the task
