...
func jobRuntimeConfig(jobCfg JobConfig, response *BootstrapResponse) *Config {
	...
	cfg := &Config{
		...
		RuntimeEnv:          serveragent.ClaudeRuntimeEnv(response.ExecutionProfile.RuntimeEnv),
		ModelUsageAliases:   cloneRuntimeModelUsageAliases(response.ExecutionProfile.ModelUsageAliases),
		Workspace:           jobCfg.Workspace,
		Model:               response.ExecutionProfile.ModelID,
		Provider:            response.ExecutionProfile.Provider,
		Protocol:            response.ExecutionProfile.Protocol,
		ContextWindow:       response.ExecutionProfile.ContextWindow,
		ReasoningEffort:     response.ExecutionProfile.ReasoningEffort,
		ThinkingRequired:    response.ExecutionProfile.ThinkingRequired,
