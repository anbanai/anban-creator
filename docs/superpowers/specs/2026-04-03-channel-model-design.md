...
| Channel scope | Single platform per channel | One Channel = one platform (WeChat public account / Seednote account). Simple isolation. |
...
- First field: Channel selector (grouped by platform: 公众号 / 种草笔记)
