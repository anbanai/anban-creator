    ...
    <>
      ...
      >
        ...
        <Button
          ...
          className="w-full border-green-500/30 bg-green-50 text-green-700 dark:border-green-600/40 dark:bg-green-900/20 dark:text-green-400"
        >
      ...
      <LoginDialog open={showQRLogin} onOpenChange={setShowQRLogin} />
    </>
  )
}
