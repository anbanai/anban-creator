...
const templates: Template[] = [
  {
    ...
    name: '清透成分说明书',
    category: '美妆护肤',
    thumbnail: { asset_id: 'asset-1', file_name: 'beauty.png', content_type: 'image/png', size: 100, download_url: 'https://example.com/beauty.png', download_expires_at: '2026-08-02T01:00:00Z' },
    prompt: '低饱和白底，封面使用产品特写与大标题，内容页保持双栏信息层级。',
    prompt_source: 'manual', readiness_status: 'ready', activate_when_ready: true,
    visibility: 'public',
    sort_order: 10,
    is_active: true,
